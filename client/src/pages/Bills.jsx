  ...
  return (
    <div className="min-h-screen bg-gray-50/50 flex flex-col font-sans">
      ...
      <main className="max-w-7xl mx-auto px-6 py-8 flex-1 w-full">
        ...
        <Card className="p-4 mb-6 flex flex-col md:flex-row gap-4 justify-between items-center">
          ...
          {(selectedMonth !== 'All' || selectedStatus !== 'All' || searchQuery) && (
            <Button
              ...
              className="text-xs font-semibold text-blue-600 hover:text-blue-700 self-end md:self-auto p-0"
            >
              Reset Filters
            </Button>
          )}
                      ...
                      <TableCell className="text-right">
                        <div className="flex items-center justify-end gap-2">
                          ...
                          <Button
                            ...
                            className="text-[11px] h-7 px-2.5 border-blue-200 bg-blue-50 text-blue-700 hover:bg-blue-100"
                          >
                            Receipt & Payment
                          </Button>
                        </div>
