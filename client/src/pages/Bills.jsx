    ...
    <div className="min-h-screen bg-gray-50/50 flex flex-col font-sans">
      ...
      <main className="max-w-7xl mx-auto px-6 py-8 flex-1 w-full">
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-8">
          ...
          <button
            onClick={fetchBills}
            className="self-start md:self-auto px-3.5 py-2 bg-white border border-gray-300 text-gray-700 hover:bg-gray-100 text-xs font-bold rounded-xl transition-all cursor-pointer inline-flex items-center gap-1.5 shadow-sm"
          >
        ...
        <div className="bg-white p-4 rounded-2xl border border-gray-200/80 shadow-sm mb-6 flex flex-col md:flex-row gap-4 justify-between items-center">
          <div className="flex flex-wrap items-center gap-3 w-full md:w-auto">
            ...
            <div className="relative flex-1 md:w-64">
              <input
                ...
                className="w-full px-3.5 py-2 bg-gray-50 border border-gray-300 rounded-xl text-xs font-medium text-gray-800 focus:outline-none focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500"
              />
            </div>
            ...
            <div className="flex items-center gap-1.5">
              ...
              <select
                ...
                className="px-3 py-2 bg-gray-50 border border-gray-300 rounded-xl text-xs font-medium text-gray-800 focus:outline-none focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 cursor-pointer"
              >
          ...
          {(selectedMonth !== 'All' || selectedStatus !== 'All' || searchQuery) && (
            <button
              ...
              className="text-xs font-semibold text-blue-600 hover:text-blue-700 self-end md:self-auto"
            >
              Reset Filters
            </button>
          )}
                        ...
                        <td className="py-3.5 px-4 text-right">
                          <div className="flex items-center justify-end gap-2">
                            ...
                            <button
                              ...
                              className="px-2.5 py-1 text-[11px] font-semibold rounded-lg bg-blue-50 hover:bg-blue-100 text-blue-700 border border-blue-200/80 transition-all cursor-pointer"
                            >
                              Receipt & Payment
                            </button>
                          </div>
      ...
      <BillPreviewModal
        ...
        onUpdate={(updatedBill) => setBills(prev => prev.map(b => b._id === updatedBill._id ? updatedBill : b))}
      />
    </div>
  );
}
